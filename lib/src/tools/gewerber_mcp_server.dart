...
final class GewerberMcpServer extends MCPServer with ToolsSupport {
    ...
    : _ctx = ctx,
      super.fromStreamChannel(
        ...
        instructions:
            ...
            'and require the admin role. All mutations are audited.',
      );
  ...
  FutureOr<InitializeResult> initialize(InitializeRequest request) {
    ...
    // asks for `tools/list`, every tool is registered.
